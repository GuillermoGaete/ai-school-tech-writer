...
Based on the provided code changes and commit messages, there are no specific updates required in the README file. The existing content remains relevant and does not need to be modified.